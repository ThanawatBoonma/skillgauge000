...
const STEP_FLOW = [
  {
    ...
    description: 'กรอกข้อมูลประจำตัว รายละเอียดตำแหน่ง ที่อยู่ และบัญชีผู้ใช้ของพนักงาน'
  },
  {
    key: 'credentials',
    title: '2) สร้างบัญชีเข้าสู่ระบบ',
    label: 'สร้างบัญชีเข้าสู่ระบบ',
    description: 'กรอกอีเมลและรหัสผ่านสำหรับเข้าสู่ระบบ'
  },
  {
    key: 'review',
    ...
    <div className="registration-page">
      <div className="registration-wrapper">
        ...
        <header className="registration-header">
          ...
          <p>เก็บข้อมูลสำคัญครบทุกหมวด ทั้งข้อมูลส่วนตัว ทักษะประสบการณ์ และบัญชีผู้ใช้</p>
        </header>
